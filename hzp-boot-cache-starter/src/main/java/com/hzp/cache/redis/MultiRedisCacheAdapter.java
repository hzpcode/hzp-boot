 ...
 *
 * @author Yu
 * @date 2020/06/03 00:35
 **/
public class MultiRedisCacheAdapter extends AbstractValueAdaptingCache {

    /**因为redisCache使用的是jdk序列化，所以此处不能改成json，否则会和RedisCacheManager冲突*/
    ...
    public MultiRedisCacheAdapter(RedisCache redisCache) {

        super(redisCache.getCacheConfiguration().getAllowCacheNullValues());

        this.name = redisCache.getName();
        this.cacheWriter = redisCache.getNativeCache();
